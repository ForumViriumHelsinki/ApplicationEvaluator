...
class RestTests(APITestCase):
    ...
    def test_application_rounds_when_none_allocated(self):
        ...
        app_round.applications.create(name="SkyNet")
        app_round.criteria.create(name="Goodness", weight=1)
    ...
    def test_application_rounds(self):
        ...
        app.scores.create(evaluator=evaluator2, score=5, criterion=criterion1)

        # And some scores for non-public criteria
        criterion2 = app_round.criteria.create(name="Wellness", weight=1, public=False)
        app.scores.create(evaluator=evaluator2, score=5, criterion=criterion2)
    ...
    def test_application_rounds_without_organizations(self):
        ...
        app.scores.create(evaluator=evaluator, score=5, criterion=criterion1)
        app.scores.create(evaluator=evaluator2, score=5, criterion=criterion1)
