...
export const submitApplicationRoundUrl = (roundId: number) =>
	`/rest/application_rounds/${roundId}/submit/`;
...
export const approveApplicationUrl = (appId: number) =>
	`/rest/applications/${appId}/approve/`;
export const unapproveApplicationUrl = (appId: number) =>
	`/rest/applications/${appId}/unapprove/`;
